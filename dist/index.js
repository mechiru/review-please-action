...
class Client {
    ...
    constructor(init) {
        this._opt = init;
        this._octokit = new (rest_1.Octokit.plugin(plugin_paginate_rest_1.paginateRest, plugin_throttling_1.throttling))({
            auth: init.auth,
            throttle: {
    ...
    async createIssueComment(no, body) {
...
async function run() {
    try {
        ...
        const client = new github_1.Client(input);
